...
<div class="container m-auto">
    ...
    <div class="lg:flex justify-center lg:space-x-10 lg:space-y-0 space-y-5">
        ...
        <div class="space-y-5 flex-shrink-0 lg:w-7/12">
            ...
            <div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0">
                ...
                <div class="flex justify-between items-center px-4 py-3">
                    ...
                    <div>
                        <a href="#" aria-expanded="false" class=""> <i class="icon-feather-more-horizontal text-2xl hover:bg-gray-200 rounded-full p-2 transition -mr-1 dark:hover:bg-gray-700"></i> </a>
                        <div class="bg-white w-56 shadow-md mx-auto p-2 mt-12 rounded-md text-gray-500 hidden text-base border border-gray-100 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700 uk-drop uk-drop-bottom-right" uk-drop="mode: hover;pos: top-right" style="left: 752.925px; top: 159px;">
        ...
        <div class="lg:w-5/12">
            ...
            <div class="mt-5 uk-sticky" uk-sticky="offset:28; bottom:true ; media @m" style="">
                <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden">
            ...
            </div><div class="uk-sticky-placeholder" style="height: 381px; margin: 20px 0px 0px;" hidden=""></div>
